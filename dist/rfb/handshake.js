...
class RfbHandshake {
    ...
    handleAuthentication(type) {
        switch (type) {
            ...
            case types_1.SecurityType.Plain:
                // MSLogon 和 Plain 都使用用户名+密码明文认证
                console.log(`[RFB] ${types_1.SecurityType[type]} 认证`);
                this.authChallengeSent = false;
                this.client.updateState(types_1.ConnectionState.Authentication);
                break;
            default:
    ...
    processAuthentication() {
        ...
        if (selectedType === types_1.SecurityType.MSLogon || selectedType === types_1.SecurityType.Plain) {
    ...
    getCurrentSecurityType() {
        ...
        return this.securityTypes[0] || types_1.SecurityType.Invalid;
    }
    /**
